...
<html>
	...
	<title>Portfolio - Sandhya Paghdar</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="Sandhya Paghdar Portfolio Web Developer" />
	<meta name="keywords" content="Sandhya, Sandhya Paghdar, Web designer, Web developer, Open to hire, Web developer portfolio, Web, HTML5, css, CSS3, responsive Website, web design, web design and develpment, javascript, Portfolio" />
	...
	<div id="fh5co-about" class="animate-box">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-8">
					<h2>Hello There!</h2>
					<p>I am living in Kithcener, Ontario. Right now, I am studying in Conestoga college - Doon campus. I do not like the winter wonderland.
						<br><br>
					Got my hands on fashion designing Worked as a student as well as professor for a Designing Institute. Rest, you can find out below.
					<p>
						<ul class="fh5co-social-icons">
									<li><a href="https://twitter.com/PaghdarSandhya" target="_blank"><i class="icon-twitter2"></i></a></li>
									<li><a href="https://linkedin.com/in/sandhya-paghdar-04ab3620a" target="_blank"><i class="icon-linkedin2"></i></a></li>
				...
				<div class="col-md-12 col-md-offset-0">
					<ul class="timeline">
						...
						<li class="animate-box timeline-unverted">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h3 class="timeline-title">Web Developer - Trainee</h3>
									<span class="company">Flying Bird Technologies - 2016</span>
								</div>
								<div class="timeline-body">
									<p>
										Troubleshot and debugged code ensuring compatibility with devices, browsers, and operating systems.<br>
										Developed user interfaces with modern lavaScript frameworks, HTML5 and CSS3.<br>
										Participated in project development through entire Software Development Lifecycle (SDLC).<br>
						...
						<li class="animate-box timeline-inverted">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h3 class="timeline-title">Fashion Designer</h3>
									<span class="company">The Bridal Boutique - 2018 - 2019</span>
								</div>
								<div class="timeline-body">
									<p>
									Worked with technical design and product management to provide accurate and complete design packages. <br>
									Developed seasonal merchandise assortment to improve category depth and breadth. <br>
									Gathered information from vendors regarding market trends and competitor activity.
									<br>
									Communicated with photographers and stylists to effectively showcase designs.<br>
									Sketched artistic and fresh designs for consideration.<br>
									Gained all the detailed knowledge about designs,colours and fabrics.
									</p>
								</div>
							</div>
						</li>
						<li class="animate-box timeline-unverted">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h3 class="timeline-title">Fashion Designing Faculty</h3>
									<span class="company">The Designer Hub - 2019 - 2020</span>
								</div>
								<div class="timeline-body">
									<p>
									Subjects on hand <br>Elements of Fashion & Design, Design Illustration, Patttern making and Garment construction, Clothing culture and Communication, Textile.
									<br><br>
									Shifted between informal and formal methods of teaching to create multi-layered web of learning incorporating experiments, practical activities, discussions and projects into lessons.<br>
									Collaborated with faculty and community stakeholders for program improvement.<br>
									</p>
								</div>
							</div>
						</li>
						...
						<li class="timeline-inverted animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h3 class="timeline-title">Post-Baccaleurate Diploma</h3>
									<span class="company">Conestoga College - 2020 - 2021</span>
								</div>
								<div class="timeline-body">
						...
						<li class="animate-box timeline-unverted">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									...
									<span class="company">Gujarat Technical University - 2012 - 2016</span>
								</div>
								<div class="timeline-body">
						...
						<li class="timeline-inverted animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									...
									<span class="company">National Institute of Design and Technology - 2017 - 2018</span>
								</div>
								<div class="timeline-body">
	...
	<div id="fh5co-skills" class="animate-box">
		<div class="container">
			...
			<div class="row row-pb-md">
				...
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
					<div class="chart" data-percent="85"><span><strong>NodeJs</strong>85%</span></div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
					<div class="chart" data-percent="90"><span><strong>ReactJS</strong>90%</span></div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6">
					...
					<div class="progress-wrap">
						<h3><span class="name-left">NodeJS</span><span class="value-right">85%</span></h3>
						<div class="progress">
				...
				<div class="col-md-6">
					...
					<div class="progress-wrap">
						<h3><span class="name-left">Databases</span><span class="value-right">85%</span></h3>
						<div class="progress">
						  <div class="progress-bar progress-bar-1 progress-bar-striped active" role="progressbar"
						  aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width:85%">
						  </div>
					...
					<div class="progress-wrap">
						<h3><span class="name-left">AngularJS</span><span class="value-right">75%</span></h3>
						<div class="progress">
						  <div class="progress-bar progress-bar-3 progress-bar-striped active" role="progressbar"
			...
			<div class="row">
				...
				<div class="col-md-3 text-center col-padding animate-box">
					<a href="#" class="work" style="background-image: url(images/portfolio-3.jpg);">
						<div class="desc">
							<h3>Interior Furniture Hardware Showroom</h3>
							<span>Php Live Project with Database</span>
						</div>
					</a>
				</div>
				<div class="col-md-3 text-center col-padding animate-box">
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					...
					<p>Posts that I have uploaded on the Social Media platform</p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
						...
						<div class="blog-text">
							<span class="posted_on">Mar. 15th 2020</span>
							<h3><a href="#">Book Store</a></h3>
							<p>Book store Website<br>
							MEAN stack project<br>
							An express project with all the books and details</p>
							<ul class="stuff">
								<li><i class="icon-heart2"></i>249</li>
								<li><i class="icon-eye2"></i>308</li>
								<li><a href="https://www.instagram.com/p/CaVPk8WvUjP/">Read More<i class="icon-arrow-right22"></i></a></li>
							</ul>
						</div> 
					</div>
				</div>
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
						...
						<div class="blog-text">
							<span class="posted_on">Feb. 15th 2021</span>
							...
							<ul class="stuff">
								<li><i class="icon-heart2"></i>249</li>
								<li><i class="icon-eye2"></i>308</li>
								<li><a href="https://www.instagram.com/p/CaVPqr_vs97/">Read More<i class="icon-arrow-right22"></i></a></li>
							</ul>
						</div> 
					</div>
				</div>
				<div class="col-md-4">
					<div class="fh5co-blog animate-box">
						...
						<div class="blog-text">
							...
							<h3><a href="#">Interior Furniture Hardware store</a></h3>
							<p>A live project with the teamwork</p>
							<ul class="stuff">
								<li><i class="icon-heart2"></i>249</li>
								<li><i class="icon-eye2"></i>308</li>
								<li><a href="https://www.instagram.com/p/CaVPztfP7BQ/">Read More<i class="icon-arrow-right22"></i></a></li>
							</ul>
						</div> 
					</div>
				</div>
	...
	<div id="fh5co-consult">
		...
		<div class="choose animate-box">
			...
			<form action="https://formsubmit.co/radhgap@gmail.com" method="POST">
				<input type="hidden" name="_next" value="https://ayhdnas.000webhostapp.com/">
